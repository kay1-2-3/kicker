...
user9 = User.create!(username:'D-CELL GAMES', email: 'buddy@D-CELLGAMES.com', password: '123456', bio: 'We make game (singular). Help support our upcoming rhythm-adventure game, UNBEATABLE! unbeatablegame.com/kicker')
...
category1 = Category.create!(name: "Arts", description: "Discover the artists and organizations using Kicker to realize ambitious projects in visual art and performance.");
category2 = Category.create!(name: "Comics & Illustration", description:"Explore fantastical worlds and original characters from Kicker’s community of comics creators and illustrators.");
...
category5 = Category.create!(name: "Food & Craft", description:"See how artisans and entrepreneurs are using Kicker to break new ground in food, fashion, and crafts.");
...
category7 = Category.create!(name: "Music", description:"Discover new albums, performances, and independent venues from creators using Kicker to shape the future of sound.");
category8 = Category.create!(name: "Publishing", description:"Explore how writers and publishers are using Kicker to bring new literature, periodicals, podcasts, and more to life.");
...
project2 = Project.create!(title: "ForeverPen",
    ...
    Ensuring we complete production on time is one of the key goals to successfully running a Kicker, so we’ve ensured we have a number of large suppliers and manufacturers who are ready for any number of pens you pledge for.",
...
project10 = Project.create!(title: "Third Editions: the Anime Library - JoJo's Bizarre Adventure",
    ...
    campaign: "This is our seventh Kicker campaign, and that in itself is a testament to our experience. We have delivered all the rewards from our first campaigns and we have learned a lot in the process.
...
project13 = Project.create!(title: "Counting, Colors & Cthulhu Hardcover Board Book",
    ...
    campaign: "This is the 9th Kicker campaign by the C is for Cthulhu team and the 21th campaign run by ComixTribe publisher Tyler James. While every campaign has its own unique challenges, we've taken several steps to mitigate the risks for this project.",
...
reward4 = Reward.create!(
    ...
    41% OFF retail prices in any size of your choice only for Early Bird Kicker supporters.
...
reward4 = Reward.create!(
    ...
    Missed our Early Bird pledges? Don't worry about it - our Kicker supporters still get 35% OFF retail prices in any size of your choice!
...
reward27 = Reward.create!(
    title: "Survival 101", 
    description: "Get an early copy of the Board Royale 2nd print base game and Kicker Exclusive Secret Weapons Expansion Pack”.
...
reward31 = Reward.create!(
    ...
    description: "This is the price GripBeats® will sell at after Kicker.",
    project_id: project20.id, 
    cost: 199)
